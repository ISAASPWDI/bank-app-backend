...
public class AppController {
    ...
    public ResponseEntity<?> getDashboard(HttpSession session){
        ...
        List<Account> getUserAccounts = accountRepository.getUserAccountsById(Math.toIntExact(userId));

        //Get Balance:
        BigDecimal totalAccountsBalance = accountRepository.getTotalBalance(Math.toIntExact(userId));
    ...
    public ResponseEntity<?> getPaymentHistory(HttpSession session){
        ...
        List<PaymentHistory> userPaymentHistory = paymentHistoryRepository.getPaymentsRecordsById(Math.toIntExact(userId));
    ...
    public ResponseEntity<?> getTransactiontHistory(HttpSession session){
        ...
        List<TransactionHistory> userTransactionHistory = transactHistoryRepository.getTransactionRecordsById(Math.toIntExact(userId));
