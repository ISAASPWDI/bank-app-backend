...
public class AccountController {
    ...
    public ResponseEntity createAccount(@RequestBody Map<String, String> requestMap, HttpSession session){
        ...
        //TODO: CREATE ACCOUNT:
        accountRepository.createBankAccount(Math.toIntExact(user_id), bankAccountNumber, accountName, accountType);


        return ResponseEntity.ok(accountRepository.getUserAccountsById(Math.toIntExact(user_id)));
