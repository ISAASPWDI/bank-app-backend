...
public class TransactController {
    ...
    public ResponseEntity deposit(@RequestBody Map<String, String> requestMap, HttpSession session) {
        ...
        //TODO: UPDATE BALANCE:
        currentBalance = accountRepository.getAccountBalance(Math.toIntExact(user_id), acc_id);
        ...
        response.put("accounts", accountRepository.getUserAccountsById(Math.toIntExact(user_id))); // Token'i JSON yanıtının içine ekleyin
    ...
    ResponseEntity transfer(@RequestBody TransferRequest request, HttpSession session) {
        ...
        user_id = user.getUser_id();
        double currentBalanceOfAccountTransferringFrom = accountRepository.getAccountBalance(Math.toIntExact(user_id), transferFromId);
        ...
        double currentBalanceOfAccountTransferringTo = accountRepository.getAccountBalance(Math.toIntExact(user_id), transferToId);
    ...
    ResponseEntity transfer(@RequestBody Map<String, String> requestMap, HttpSession session) {
        ...
        //TODO: GET CURRENT BALANCE:
        user_id = user.getUser_id();
        currentBalance = accountRepository.getAccountBalance(Math.toIntExact(user_id), account_id);
    ...
    ResponseEntity transfer(@RequestBody PaymentRequest request, HttpSession session) {
        ...
        //TODO: GET CURRENT BALANCE:
        user_id =user.getUser_id();
        currentBalance = accountRepository.getAccountBalance(Math.toIntExact(user_id), accountID);
